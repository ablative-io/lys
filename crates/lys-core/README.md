...
- **Identity** — Ed25519 keypairs and X.509 capability certificates (strict verification, validity-window enforcement, PKCS#10 proof of possession so a certificate binds a key its holder controls).
