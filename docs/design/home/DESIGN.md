...
- Forks at a coordinate, including the fork through a lantern (stage 5b). — Stage 5b is its own card: it needs the per-harness cut-and-seed measurement. Lanterns themselves (stage 5) are HOME-004.
